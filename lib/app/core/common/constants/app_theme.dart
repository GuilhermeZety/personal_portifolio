...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    iconTheme: const IconThemeData(color: AppColors.grey_700),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedErrorBorder: const UnderlineInputBorder(
        borderRadius: BorderRadius.zero,
        borderSide: BorderSide(width: 2.5, color: AppColors.error),
      ),
    ),
  );
  static ThemeData get dark => ThemeData(
    ...
    drawerTheme: const DrawerThemeData(elevation: 2, backgroundColor: AppColors.grey_900),
    iconTheme: const IconThemeData(color: AppColors.grey_200),
    bottomSheetTheme: const BottomSheetThemeData(backgroundColor: Colors.transparent),
